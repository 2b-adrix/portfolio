  ...
  return (
    <div className="py-10">
      <div className="flex flex-col items-center mb-10 px-4 text-center">
        ...
        <p className="text-[var(--text-secondary)] mt-3 uppercase tracking-[0.2em] sm:tracking-[0.3em] font-bold text-[10px] sm:text-xs">Production Grade Android Apps</p>
      </div>
              ...
              <div className="px-4">
                <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h1 className="font-bold lg:text-2xl md:text-xl text-base line-clamp-1 text-[var(--text-primary)] flex items-center gap-1">
                                {item.title}
                                <MdVerified className="text-[#00DE8A] text-lg" />
                            </h1>
                            <div className="flex items-center gap-1">
                                <span className="text-[10px] text-[var(--text-secondary)] font-bold uppercase tracking-wider">Android App</span>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col items-end">
                        ...
                        <span className="text-[9px] text-[var(--text-secondary)] font-bold">100+ Builds</span>
                    </div>
                </div>

                <p
                  className="lg:text-xl lg:font-normal font-light text-sm line-clamp-2 text-[var(--text-secondary)] mb-5 leading-relaxed"
                >
                  {item.des}
                </p>
                ...
                <div className="flex items-center justify-between mt-7 mb-3">
                  <div className="flex items-center">
                    {item.iconLists.map((icon, index) => (
                      <div
                        key={index}
                        className="border border-white/[.2] rounded-full bg-[var(--bg-surface)] lg:w-10 lg:h-10 w-8 h-8 flex items-center justify-center shadow-sm"
                        style={{
