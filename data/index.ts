...
export const gridItems = [
  {
    ...
    description: "",
    className: "col-span-1 lg:col-span-3 lg:row-span-2 min-h-[350px] lg:min-h-[450px]",
  ...
  },
  {
    ...
    description: "",
    className: "col-span-1 lg:col-span-2 lg:row-span-1 min-h-[200px]",
    imgClassName: "",
  ...
  },
  {
    ...
    className: "col-span-1 lg:col-span-2 lg:row-span-1 min-h-[250px]",
    imgClassName: "",
  ...
  },
  {
    ...
    className: "col-span-1 lg:col-span-3 lg:row-span-2 min-h-[250px]",
